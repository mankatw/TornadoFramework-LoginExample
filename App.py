...
class ErrorBaseHandler(tornado.web.ErrorHandler):
    def get_error(self):
        return tornado.escape.json_decode("System has encountered a DB error") 

class InternalError(ErrorBaseHandler):
    def get(self):
        return self.render("error_template.html", ErrorBaseHandler.get_error(self))  
